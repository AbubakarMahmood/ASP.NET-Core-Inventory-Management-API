        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceLocation = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    DestinationLocation = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilterPresets_EntityType",
                table: "FilterPresets",
                column: "EntityType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilterPresets_UserId_EntityType_Name",
                table: "FilterPresets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Category_CurrentStock",
                table: "Products",
                columns: new[] { "Category", "CurrentStock" });
